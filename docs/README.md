...
- **[Workday sessions and working time limits](features/WORKDAY_SESSIONS.md)** — Clock-in/out without a project; daily/weekly caps with email and justification (separate from project hours)
...
### Deployment
- **[Distribution & Download](admin/deployment/DISTRIBUTION.md)** — All install paths and marketplaces
